$(function () {
	...
	var deadline = $('#w20240103afbda31e55708').find('._widget_data ').find('.form-widget').find('.deadline-bar');
	...
	$.submit_btn = function(){
		$('.submit_btn').on('click',function(){
			...
			$('#input_txt_5153671339b9e').val('-')
			$('#input_txt_37E8A55T9b').val('-')
			$('#input_txt_3Th428193F').val('-')
			...
			SITE_FORM.confirmInputForm('w20240103afbda31e55708','N');
			setTimeout(() => $('#input_form_complete_modal_w20240103afbda31e55708').find('.btn').trigger('click'), 1000);
